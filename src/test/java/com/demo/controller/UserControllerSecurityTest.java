...
class UserControllerSecurityTest {
    ...
    @Test
    void byId_rejectsSqlInjectionPayload() throws Exception {
    ...
    @Test
    void list_rejectsInvalidSortColumn() throws Exception {
    ...
    @Test
    void list_allowsValidSortColumn() throws Exception {
        mockMvc.perform(get("/api/users/list")
